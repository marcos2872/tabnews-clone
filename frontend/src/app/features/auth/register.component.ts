    ...
    <div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md mt-10">
      ...
      <form [formGroup]="registerForm" (ngSubmit)="onSubmit()" class="space-y-4">
        <div>
          ...
          <input type="text" formControlName="username" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border">
        </div>
         <div>
